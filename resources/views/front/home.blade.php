    ...
    <section class="py-5 px-4 px-md-0 hero" style="background-color:#ADDEFF;">
        <div class="container pt-5">
            ...
            <div class="row py-3 py-lg-5">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ asset('assets/images/buying-selling-user-car.svg') }}" alt="Car">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="container">
                        ...
                        <div class="container pt-4 mt-4 pt-lg-5">
                            <div class="row">

                                @if($plans)
                                    @foreach($plans as $key=>$plan)

                                        <div class="col-lg-4 col-md-6 mb-3 mb-lg-0  {{ (count($plans) == ($key+1)) ? 'pro_box' : '' }} ">
                                            <div class="packages bg-white p-4 " style="border-radius:24px; {{ (count($plans) == ($key+1)) ? 'pro_box' : '' }} ">

                                                <h3>{{ $plan->category .' - '. $plan->name }}</h3>
                                                <p>{{ $plan->description }}</p>
                                                <ul class="navbar-nav py-3">
                                                    @php $features = json_decode($plan->features); @endphp
                                                    @foreach($features as $feature)
                                                        <li class="nav-item text color-secondary"><img src="{{ asset('assets/images/check.svg') }}" class="me-2"/> <span>{{ $feature }}</span></li>
                                                    @endforeach
                                                </ul>

                                                <p class="d-flex flex-row price_box">
                                                    <sub style="color: #0071BC;margin-top: 3px;">&dollar;</sub>
                                                    <span class="me-1"><span class="text2">{{ $plan->price }}</span><span class="text1" style="display:none">{{ $plan->price }}</span></span>
                                                    <sub style="color: #424242;margin-top: 5px;">/ {{ $plan->number_of_reports }} Reports </sub>
                                                </p>

                                                <a href="{{ route('generateInvoice', [$plan->id]) }}" class="b2c_tbn">Choose</a>
                                ...
                                @else
                                    <div class="col-12">
                                        <h5 class="text-center">No Plan found</h5>
                                    </div>
                                @endif
