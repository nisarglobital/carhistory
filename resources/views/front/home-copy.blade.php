                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                                    <div class="packages bg-white p-4 " style="border-radius:24px;">
                                        ...
                                        <a href="{{ (auth()->check() ? route('payment', ['plan-1']) : route('register', ['plan-1'])) }}" class="b2c_tbn">Choose</a>
                                ...
                                <div class="col-lg-3  col-md-6 mb-3 mb-lg-0">
                                    <div class="packages bg-white p-4 " style="border-radius:24px;">
                                        ...
                                        <a href="{{ (auth()->check() ? route('payment', ['plan-2']) : route('register', ['plan-2'])) }}" class="b2c_tbn">Choose</a>
                                ...
                                <div class="col-lg-3   col-md-6  mb-3 mb-lg-0 pro_box">
                                    <div class="packages p-4 " style="border-radius:24px;background:#0071BC;">
                                        ...
                                        <a href="{{ (auth()->check() ? route('payment', ['plan-3']) : route('register', ['plan-3'])) }}" class="b2c_tbn bg-white">Try 1 month</a>
                                ...
                                <div class="col-lg-3  col-md-6 ">
                                    <div class="packages bg-white p-4 " style="border-radius:24px;">
                                        ...
                                        <a href="{{ (auth()->check() ? route('payment', ['plan-4']) : route('register', ['plan-4'])) }}" class="b2c_tbn">Choose</a>
