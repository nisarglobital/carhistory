        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    <h5 class="mb-0">Manage Users - Create</h5>
                </div>
            </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="mt-1">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="type" id="user" value="user" {{ (old('type') == 'user' ? 'checked' : '') }} required>
                                            <label class="form-check-label" for="user">User (front-end users Free, Premium)</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="type" id="admin" value="admin"  {{ old('type') == 'admin' ? 'checked' : '' }} required>
