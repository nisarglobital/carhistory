        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    <h5 class="mb-0">Manage Plans - Create</h5>
                </div>
            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" name="number_of_reports" id="number_of_reports" class="form-control" value="{{ old('number_of_reports') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" name="price_per_report" id="price_per_report" class="form-control" step="0.01" value="{{ old('price_per_report') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="billing_cycle" id="billing_cycle" class="form-control" required>
                                        ...
                                        <option value="allowed_numbers" {{ (old('billing_cycle') == 'allowed_numbers') ? 'selected' : '' }}>Allowed Numbers</option>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="subscription_term" id="subscription_term" class="form-control" value="{{ old('subscription_term', 1) }}">
                                </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="category" id="category" class="form-control" required>
                                                <option value="" selected disabled >Select an Option</option>
                                                <option {{ (old('category') == 'B2C') ? 'selected' : '' }} value="B2C">B2C</option>
                                                <option {{ (old('category') == 'B2B') ? 'selected' : '' }} value="B2B">B2B</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="plan_type" id="plan_type" class="form-control" required>
                                                <option value="" selected disabled >Select an Option</option>
                                                <option value="report_based" {{ (old('plan_type') == 'report_based') ? 'selected' : '' }} >Report-Based</option>
                                                <option value="subscription_based" {{ (old('plan_type') == 'subscription_based') ? 'selected' : '' }} >Subscription-Based</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" name="monthly_cost" id="monthly_cost" class="form-control" step="0.01" value="{{ old('monthly_cost') }}">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group mb-3">
                                            <label class="form-label" for="discount">Discount (%): <span class="text-danger">*</span></label>
                                            <input type="number" name="discount" id="discount" class="form-control" step="0.001" required value="{{ old('discount') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" name="total_cost" id="total_cost" class="form-control" step="0.01" required value="{{ old('total_cost') }}" >
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group mb-3">
                                            <label class="form-label" for="total_savings">Total Savings per Month: <span class="text-danger">*</span></label>
                                            <input type="number" name="total_savings" id="total_savings" class="form-control" step="0.01" value="{{ old('total_savings') }}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" name="price" id="price" class="form-control bg-light" step="0.01" required value="{{ old('price') }}" >
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="features" id="features" class="form-control" rows="4" required>{{ old('features') }}</textarea>
                                </div>
                            </div>
